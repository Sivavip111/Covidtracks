...
<body>
		...
		<div class="container agile-banner_nav">
			<div class="row header-top">
				<div class="col-md-5 top-left p-0">
					<p>
						<i class="fa fa-phone" aria-hidden="true"></i> Call us : 91-9898989898
					</p>
				</div>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h3>
					<a class="navbar-brand" href="index.jsp">Covid Tracker System</a>
				</h3>
				...
				<div class="collapse navbar-collapse justify-content-center"
					...
					<ul class="navbar-nav ml-auto">
						<li class="nav-item"><a class="nav-link"
							href="user-login.jsp">User Login</a></li>
						<li class="nav-item"><a class="nav-link"
							href="admin-login.jsp">Admin Login</a></li>
						<li class="nav-item"><a class="nav-link" href="about.jsp">About</a>
						</li>
						<li class="nav-item pr-lg-0"><a class="nav-link pr-lg-0"
	...
	<section class="welcome py-5">
		<div class="container py-md-3">
			<h3 class="heading text-center mb-md-5 mb-4">Covid-19 Precautionary Measures</h3>
			<div class="row welcome-grids">
				<div class="col-lg-6">
					<p class="my-4"><b>Check with your local health authority for the most relevant guidance for your region.</b></br>
