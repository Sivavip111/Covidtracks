		...
		<div class="w3l-book-9">
			<div class="main-top">
				<div class="wrapper padding-bord">
					...
					<%
						ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tbldoctor where duname='" + session.getAttribute("uname") + "'");
						if (rs.next()) {
					%>
					<form action="" method="">
						<div class="d-grid grid-col-2">
							...
							<div class="ele-9its_grid">
								...
								<input type="text" name="fname" class="input"
									value="<%=rs.getString("dname")%>" readonly/>
							</div>
