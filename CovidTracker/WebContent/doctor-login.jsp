...
<body>
					...
					<div class="bottom-menu-content">
						...
						<nav>
							<ul class="menu">
								...
								<li><a href="doctor-register.jsp" class="link-nav">Doctor Register</a></li>
							</ul>
						</nav>
					</div>
				</div>
	...
	<section class="w3l-form-34-main">
		<div class="form34-sub">
			<div class="form34">
				<h4 class="form-head">Doctor Login</h4>
				<br>
				...
				<%
					...
					%>
					<div class="alert alert-success" id="success" style="color:green"><%=credential%></div>
					<%
						}
					%>
				...
				<form action="DoctorLogin" method="post">
					<div class="">
						<p class="text-head">Doctor Login</p>
						<input type="text" class="input" placeholder="User Name" required name="uname"/>
					</div>
					<div class="">
						<p class="text-head">Password</p>
						<input type="password" class="input" placeholder="Your Password" required name="upass"/>
					</div>
					<%
						String captcha = null;
					...
					<div class="">
						...
						<input type="text" name="vercode" class="input"	required style="width: 350px;" placeholder="Enter Catptcha Here" />&nbsp;
						<input type="text" value="<%=captcha%>" class="input" style="width: 80px;" readonly />
					</div> 
					<button type="submit" class="buttonbg signinbutton">Login</button>
					<p class="signup">Have not an account yet?<a href="doctor-register.jsp" class="signuplink">Sign up</a>
					</p>
				</form>
			</div>
		</div>
