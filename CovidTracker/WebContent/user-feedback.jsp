			...
			<div class="form34">
				...
				<form action="AddFeedback" method="post">
					<div class="">
						...
						<%
							String fid = DatabaseConnection.generatePatientFeedbackId();
						%>
						<input type="text" class="input" placeholder="Feedback Id" name="fid" value="<%=fid%>" readonly />
					</div>
					<div class="">
						<p class="text-head">Your Feedback</p>
						<input type="text" class="input" placeholder="Your Feedback" style="height: 100px;" name="feedback" required/>
					</div>
					<button type="submit" class="buttonbg signinbutton">Submit Feedback</button>
				</form>
			</div>
		</div>
	</section>
