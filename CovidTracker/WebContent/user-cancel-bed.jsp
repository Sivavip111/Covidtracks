			...
			<div class="col-sm-12">
				<table class="table table-bordered">
					...
					<%
						...
						String query = "select * from bed_booking where uid='"+user_id+"'"; System.out.println("query::::::>> "+query);
					...
					<tbody>
						<tr>
							...
							<td><a href="user-cancel-sbt.jsp?user_id=<%=resultset.getString(2)%>" class="btn btn-danger" style="width: 100px;">Cancel</a>
							</td>
						</tr>
