		...
		<div class="w3l-book-9">
			<div class="main-top">
				<div class="wrapper padding-bord">
					<p class="form-para">
						<strong>Covid Tracker - Doctor Visit</strong>
					</p>
					...
					%>
						...
						<tr>
							<th>Phone</th>
							<td><input type="text" name="phoneno" readonly="readonly" value="<%=resultset.getString("phoneno")%>"/></td>
						</tr>
						<tr>
						...
						<tr>
							<th>Start Date</th>
							<td><input type="text" name="asigndocdate" readonly="readonly" value="<%=resultset.getString("asigndocdate")%>"/></td>
						</tr>
					<%
						}
					%>
						...
						<tr>
							<th>Daily Vist Time</th>
							<td><input type="text" name="dvt" id="dvt"/></td>
						</tr>
						<tr>
							<th>End Date</th>
						...
						<tr>
							<th>Medicine</th>
							<td><input type="text" name="medicine" id="medicine"/></td>
						</tr>
						
						<tr>
							<th>Summary</th>
							<td><textarea name="summary" id="summary" cols="40" rows="3"></textarea></td>
						</tr>

					<tr>
						<td>
							<a href="#" onclick="javascript:summarysbt('<%=patid%>');" class="btn btn-danger" style="width: 100px;">
								Submit Summary</a>  &nbsp;
						</td>
					</tr>					
...
function summarysbt(patid) { 
	var enddate = document.getElementById('enddate').value;
	var summary = document.getElementById('summary').value;
	var dvt = document.getElementById('dvt').value;
	var medicine = document.getElementById('medicine').value;
	
	window.location.href = "./doctor-pati-summary.jsp?summary="+summary+"&enddate="+enddate+"&patient_id="+patid+"&dvt="+dvt+"&medicine="+medicine;
}
