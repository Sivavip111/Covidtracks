			...
			<div class="col-sm-12">
				<table class="table table-bordered">
					...
					<%
						...
						String query = "select * from tblpatient where docname='"+dname+"'"; System.out.println("query::::::>> "+query);
					...
					<tbody>
						<tr>
							...
							<td><a href="doctor-patient-view.jsp?patient_id=<%=resultset.getString(1)%>" class="btn btn-danger" style="width: 100px;">View</a>
							</td>
						</tr>
