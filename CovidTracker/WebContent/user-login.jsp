					...
					<div class="bottom-menu-content">
						...
						<nav>
							<ul class="menu">
								...
								<li><a href="user-register.jsp" class="link-nav">User Register</a></li>
							</ul>
						</nav>
					</div>
				</div>
			...
			<div class="form34">
				...
				<form action="UserLogin" method="post">
					...
					<div class="">
						...
						<input type="text" required name="vercode" class="input"	style="width: 350px;" placeholder="Enter Catptcha Here" />
