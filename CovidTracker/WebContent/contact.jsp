...
<meta charset="utf-8">
<meta name="keywords"
	content="In Travel Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<body>
		...
		<div class="container agile-banner_nav">
			<div class="row header-top">
				...
				<div class="col-md-7 top-right p-0">
					<p>
						<i class="fa fa-map-marker" aria-hidden="true"></i> Covid Tracker
				</div>
			</div>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h3>
					<a class="navbar-brand" href="index.jsp">Covid Tracker</a>
				</h3>
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item"><a class="nav-link" href="user-login.jsp">User Login</a></li>
						<li class="nav-item"><a class="nav-link" href="admin-login.jsp">Admin Login</a></li>
						<li class="nav-item"><a class="nav-link" href="doctor-login.jsp">Doctor Login</a></li>
						<li class="nav-item"><a class="nav-link" href="about.jsp">About</a>
						</li>
						<li class="nav-item pr-lg-0"><a class="nav-link pr-lg-0" href="contact.jsp">Contact</a></li>
						<li class="nav-item"><a class="nav-link" href="covid-precautionary.jsp">Precautionary</a></li>
				...
				<div class="col-lg-5 col-md-6 agileits_w3layouts_contact_gridl">
					<div class="agileits_mail_grid_right_grid">
						...
						<ul class="contact_info">
							<li><span class="fa fa-map-marker" aria-hidden="true"></span>Covid Tracker System</li>
							<li><span class="fa fa-envelope" aria-hidden="true"></span><a href="">info@covid.com</a></li>
							<li><span class="fa fa-phone" aria-hidden="true"></span>(+91)9898989898</li>
							<li><span class="fa fa-globe" aria-hidden="true"></span><a href="#">info@covid.com</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-7 col-md-6 mt-md-0 mt-5 w3l_contact_form">
					...
					<form action="AddContact" method="post">
						...
						<input type="email" name="email" value="Email"	onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}"
							required=""> <input type="text" name="phone" value="Phone" onfocus="this.value = '';"
	...
	<section class="copyright py-4 text-center">
		<div class="container">
			<p>
				© 2022 Student Covid Tracker. All Rights Reserved | Design by <a href="" target="=_blank"> G.S.C.H </a>
			</p>
		</div>
	</section>
	<!-- //copyright -->
