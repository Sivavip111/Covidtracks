		...
		<div class="w3l-book-9">
			<div class="main-top">
				<div class="wrapper padding-bord">
					...
					String patquery = "select * from tblpatient where pat_id='" + pat_id + "'"; System.out.println("patquery:::: "+patquery);
						ResultSet rs = DatabaseConnection.getResultFromSqlQuery(patquery);
						if (rs.next()) {
					%>
					<form action="UserUpdateProfile" method="post">
						<div class="d-grid grid-col-2">
							<div class="ele-9its_grid">
								...
								<input type="text" name="pid" class="input"
									value="<%=rs.getString("pat_id")%>" readonly />
							</div>
							<div class="ele-9its_grid">
								<p class="text-left">
						...
						<div class="d-grid grid-col-2">
							...
							<div class="ele-9its_grid">
								...
								<input type="text" name="aadno" class="input"
									value="<%=rs.getString("aadno")%>" />
							</div>
						</div>
						<div class="d-grid grid-col-2">
							<div class="ele-9its_grid">
