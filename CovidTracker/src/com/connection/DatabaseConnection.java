...
public class DatabaseConnection {
	...
	public static Connection getConnection() {
		try {
			...
			connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/covid_tracker","root","");
	...
	public static String generatePatientFeedbackId() {
		String fid = null;
	...
	public static String generatePatientUserId() {
		String uid = null;
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddhhmmss");
	...
	public static String generateDoctorUserId() {
		String uid = null;
		SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddhhmmss");
		uid = sdf.format(new Date());
		uid = "D" + uid;
